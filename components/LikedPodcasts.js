    ...
    return (
        <div className="flex flex-col items-start justify-end group bg-gradient-to-br from-green-900 via-green-700 to-green-400 lg:w-85 md:w-85 w-full cursor-pointer py-5 px-4 h-54 rounded-lg">
           ...
           <div className=" flex justify-between items-end w-full">
                ...
                <div className="lg:drop-shadow-2xl hidden lg:flex group-hover:opacity-100 lg:z-20 opacity-0 cursor-default rounded-full bg-spotify-green w-10 h-10 p-2 hover:scale-110  transition-all duration-300">
