...
function DefaultSongComponent({isLiked, isAlbum}) {
    return (
            ...
            <tr className=" cursor-default rounded-md group dark:hover:bg-card-hover dark:bg-main-bg bg-white hover:bg-gray-100 transition-all duration-150">
                <td className="py-2 px-2 w-8 font-light text-xxs"><p className="block group-hover:hidden">1</p> <PlayIcon className="w-4 h-4 dark:text-gray-100 text-main-bg hidden group-hover:block" /> </td>
                <td className="py-2">
                    <div className="flex space-x-3 items-center justify-start">
                        ...
                        <div className="flex flex-col space-y-1"><p className="text-xs dark:text-gray-100 text-main-bg">Wish You Were Here &#40;feat. Khalid&#41;</p><p className="text-xxs text-gray-400">Jacob Banks</p></div>
                    </div>
                    </td>  
                <td className={`${isAlbum?"hidden":"py-2 text-xxs dark:text-gray-400 text-gray-700"}`} >Wish You Were Here &#40;feat. Khalid&#41;</td>
                <td className={`${isAlbum?"hidden":"py-2 text-xxs dark:text-gray-400 text-gray-700"}`} >1 day ago</td>
                <td className="py-2 text-right pr-4"><div className="flex justify-start items-center space-x-4"><div className="flex justify-end items-center space-x-6"><HeartIcon className={`w-5 h-5 ${isLiked?"text-spotify-green":"dark:text-gray-700 text-gray-300"}`} /><p className="text-xxs dark:text-gray-400 text-gray-700">3:55</p></div><DotsHorizontalIcon className="w-4 h-4 opacity-0 group-hover:opacity-100" /></div></td>
            </tr>
