...
function DefaultSongComponent({isLiked}) {
    return (
            ...
            <tr className=" cursor-default rounded-md group hover:bg-card-hover transition-all duration-150">
                ...
                <td className="py-2 text-xxs text-gray-400" >Wish You Were Here &#40;feat. Khalid&#41;</td>
                <td className="py-2 text-xxs text-gray-400" >1 day ago</td>
