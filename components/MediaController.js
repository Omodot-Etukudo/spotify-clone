import { HeartIcon, ViewGridIcon, ViewListIcon , VolumeUpIcon, DesktopComputerIcon} from "@heroicons/react/outline"
...
function MediaController() {
    return (
        <div className="absolute">
            <div className="lg:fixed hidden left-0 -bottom-60 z-50"><Image width={255} height={250} src={`${BASE_URL}${"ab67616d0000b27327b8470985bb498d4fd8cee3"}`}></Image></div>
                ...
                <div className="hidden lg:flex flex-row justify-between px-6">
                    ...
                    <div>
                        <div className=" flex justify-between">
                            <div className="absolute group">
                                <Image className="rounded-sm drop-shadow-2xl shadow-2xl z-10" src={`${BASE_URL}${"ab67616d0000b27327b8470985bb498d4fd8cee3"}`} width={55} height={55} loading="lazy"></Image>
                                <div className="relative group-hover:block hidden -top-14 p-1 w-6 left-7 z-50 rounded-full bg-black hover:scale-110 transition-transform duration-100 black bg-opacity-70 hover:text-white"><ChevronUpIcon className="  w-4 h-4"/></div>
                            </div>
                    ...
                    <div className="flex flex-col">
                        <div className="flex space-x-4 mx-auto my-auto">
                            <RewindIcon className="w-6 h-6 my-auto hover:text-white transition-colors duration-100"/>
                            <PlayIcon className="w-10 h-10 text-white hover:scale-110 transition-all duration-100"/>
                            <FastForwardIcon className="w-6 h-6 my-auto hover:text-white transition-colors duration-100"/>
                        </div>
                        <div className="flex space-x-2 px-24">
                            <h1 className="text-xs my-auto">0:00</h1>
                            <input type="range" min="1" max="100" className="ml-2 h-1 w-110 my-2 slider" />
                    ...
                    <div className="flex space-x-3 my-auto">
                        ...
                        <div className="flex">
                            <VolumeUpIcon className="w-5 h-5 hover:text-white transition-colors duration-300" />
                            <input type="range" min="1" max="100" className="ml-2 h-1 my-2 slider" />
                        </div>
                    </div>
                </div>
                {/* MOBILE COMPONENTS */}
