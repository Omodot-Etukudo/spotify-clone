...
function Feed() {
    return (
        <div className="h-full lg:h-full lg:pl-72 lg:max-w-full max-w-full min-w-full py-20 lg:py-20 px-3 lg:px-10 bg-gradient-to-tl from-black  via-gray-900 to-dark-red lg:from-gray-900 lg:via-gray-900 lg:to-black">
            <div className="lg:mb-10 mb-8">
                <div className="flex justify-between">
                    ...
                    <div>
                        <h3 className="uppercase font-semibold cursor-pointer text-xs lg:text-sm tracking-wide hover:underline hover:text-white transition-all duration-200 lg:mt-8 mt-2">See All</h3>
                    </div>
                </div>
                <div className="lg:py-4 w-full max-w-full lg:max-w-full lg:w-full h-56 lg:h-72 lg:grid lg:grid-cols-5 lg:gap-6">
                    <div className="mr-20"><Mediacard year="2021" picture="ab67616d0000b273b87ac71d440973d20f4c8473" title="Chilombo" artist="Jhené Aiko" /></div>
                    <div className="mr-20"><Mediacard year="2020" title="After Hours" artist="The Weeknd" picture="ab67616d0000b2738863bc11d2aa12b54f5aeb36"/></div>
                    <div className="mr-20"><Mediacard year="2020" title="Somewhere between beauty and magic" artist="Joeboy" picture="ab67616d00001e0234347b639c35a6e57664fb38"/></div>
                    <div className="mr-20"><Mediacard year="2021" title="For Broken Ears" artist="Tems" picture="ab67616d00001e020ab4d3e1c0b5c5e453287a4c"/></div>
                    <div className="mr-20"><Mediacard year="2021" title="Chemtrails Over The Country Club" artist="Lana Del Rey" picture="ab67616d0000b273e77203dd587322b5f2ddd3f4"/></div>
                </div>
            ...
            <div className="lg:mb-10 mb-8">
                ...
                <div className="lg:py-4 w-12/12 lg:w-full h-56 lg:h-72 lg:grid lg:grid-cols-5 lg:gap-6 flex flex-row flex-nowrap">
