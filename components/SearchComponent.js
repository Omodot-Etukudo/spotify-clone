           ...
           <div className="hidden lg:block">
               <div>
                    ...
                    <div className="flex space-x-6 h-60 overflow-y-hidden overflow-x-scroll whitespace-nowrap scrollbar-hide">
                        ...
                        <Topgenres title="Pop" image="ab67706f00000003f336332699dd46ae4396e15f" background="cursor-pointer bg-gradient-to-r from-purple-800 via-purple-700 to-purple-600" />
