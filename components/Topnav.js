...
function Topnav() {
    return (
        <div className="fixed top-0 lg:bg-gray-800 bg-opacity-30 px-5 lg:px-10 w-full min-w-full h-14 lg:h-14 lg:min-h-14 lg:max-h-14">
            <div className=" w-10/12 pr-6 py-2 hidden lg:flex justify-between">
                ...
                <div className="py-0.5 hover:cursor-pointer pr-0 mr-16 right-56 absolute w-36 max-w-32 min-w-32">
                    ...
                    <div className="bg-black bg-opacity-80 w-56 relative top-1 right-20 rounded p-1 dropdown-active shadow-2xl">
