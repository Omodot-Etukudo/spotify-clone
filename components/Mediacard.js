...
function Mediacard({picture, title, artist,year}) {
    ...
    return (
        <div className="group">
            <div className="lg:absolute cursor-pointer w-32 lg:w-48 lg:bg-black bg-opacity-50 lg:px-4 pt-4 pb-5 flex flex-col rounded lg:group-hover:bg-gray-800 transition-colors duration-500">
                <div><Image placeholder="blur" blurDataURL loading="lazy" className="lg:rounded z-10" width={220} height={220}  src={`${BASE_URL}${picture}` || `${BASE_URL2}${picture}`} /></div>
